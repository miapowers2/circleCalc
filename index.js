...
app.post("/", function(req, res){
    ...
    var cylinderHeight = req.body.height;

    var volumeCylider = Math.PI * Math.pow(radCircle, 2) * cylinderHeight;


// sends the results back to the web page as string
  res.send("The Volume of the Cylider is " + volumeCylider.toFixed(2));
})
